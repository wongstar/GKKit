...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        UILabel *lineOfBtns=[[UILabel alloc] initWithFrame:CGRectMake(i*buttonWidth, container.bounds.size.height-buttonHeight, 1/[UIScreen mainScreen].scale, buttonHeight)];
