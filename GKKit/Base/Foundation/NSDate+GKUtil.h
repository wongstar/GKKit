 ...
 */
+ (nullable NSDate *)dateWithString:(NSString *_Nullable)dateString format:(NSString *_Nullable)format;
...
/**
 ...
 If can not parse the string, returns nil.
 */
+ (nullable NSDate *)dateWithString:(NSString *_Nullable)dateString
...
/**
 ...
 If can not parse the string, returns nil.
 */
+ (nullable NSDate *)dateWithISOFormatString:(NSString *_Nullable)dateString;
