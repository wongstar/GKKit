...
- (void)layoutSubviews {
    ...
    self.drawRect=clearDrawRect;
    MoveTo(qrMenu, (self.width-qrMenu.width)/2, clearDrawRect.origin.y+clearDrawRect.size.height+10);
    
    MoveTo(descrption, (self.width-descrption.width)/2, clearDrawRect.origin.y-40);
}
...
- (void)initQrMenu {
    ...
    label.text = LSTR(@"将二维码放入框内, 即可自动扫描");
...
- (void)addCornerLineWithContext:(CGContextRef)ctx rect:(CGRect)rect{
    ...
    CGContextSetRGBStrokeColor(ctx, 120 /255.0, 214/255.0, 37/255.0, 1);//绿色
