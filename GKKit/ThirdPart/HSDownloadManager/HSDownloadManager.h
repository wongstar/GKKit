...
// 缓存主目录
#define HSCachesDirectory [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"Documents/iJiDou"]
...
-(BOOL)taskisRunning:(NSString *)url;

-(BOOL)isExitFile:(NSString *)url;
